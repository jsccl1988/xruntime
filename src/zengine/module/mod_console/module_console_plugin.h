...
#include "zengine/module/mod_console/console_listener.h"
#include "zengine/module/mod_console/console_thread.h"
#include "zengine/module/mod_console/base_console.h"
...
public:
  static ModuleConsolePluginFactory* GetInstance() {
    return base::Singleton<ModuleConsolePluginFactory>::get();
  }
...
private:
  friend struct base::DefaultSingletonTraits<ModuleConsolePluginFactory>;
